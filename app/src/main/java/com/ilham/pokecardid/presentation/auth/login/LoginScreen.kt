package com.ilham.pokecardid.presentation.auth.login
...
fun LoginScreen(
    ...
    LaunchedEffect(loginState) {
        when (loginState) {
            ...
            is Response.Error -> {
                errorDialogMessage = loginState.message ?: "Terjadi Kesalahan!"
    ...
    Column(
        ...
        BaseText(text = "Login", fontSize = 24.sp, fontWeight = FontWeight.Bold)
